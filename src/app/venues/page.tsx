...
const REGIONS: Record<string, string[]> = {
  "San Francisco": ["San Francisco", "Sausalito", "Tiburon", "Mill Valley", "San Rafael", "Novato", "Marin", "Muir Beach", "Stinson Beach"],
  "East Bay": ["Oakland", "Berkeley", "Walnut Creek", "Concord", "Pleasanton", "Livermore", "Dublin", "San Ramon", "Danville", "Alamo", "Lafayette", "Orinda", "Fremont", "Hayward", "Newark", "Union City", "Alameda", "Emeryville", "Albany", "El Cerrito", "Richmond", "Pinole", "Hercules", "Martinez", "Brentwood", "Antioch", "Pittsburg", "Oakley"],
  "Peninsula & South Bay": ["San Mateo", "Burlingame", "Hillsborough", "Redwood City", "Menlo Park", "Palo Alto", "Los Altos", "Mountain View", "Sunnyvale", "Santa Clara", "San Jose", "Saratoga", "Los Gatos", "Campbell", "Morgan Hill", "Gilroy", "Half Moon Bay", "Pacifica", "Woodside", "Portola Valley", "Atherton", "Foster City", "Belmont", "San Carlos", "Millbrae", "San Bruno", "South San Francisco", "Daly City"],
  "Napa Valley": ["Napa", "Yountville", "Oakville", "Rutherford", "St Helena", "Calistoga", "American Canyon", "Pope Valley", "Angwin"],
  "Sonoma County": ["Sonoma", "Santa Rosa", "Healdsburg", "Petaluma", "Sebastopol", "Windsor", "Geyserville", "Cloverdale", "Glen Ellen", "Kenwood", "Guerneville", "Forestville", "Graton", "Occidental", "Rohnert Park", "Cotati", "Boyes Hot Springs"],
  ...
  "Monterey & Carmel": ["Monterey", "Carmel", "Pacific Grove", "Pebble Beach", "Big Sur", "Carmel Valley", "Seaside", "Marina", "Salinas", "Castroville", "Moss Landing", "Half Moon Bay"],
  "Santa Barbara": ["Santa Barbara", "Montecito", "Goleta", "Carpinteria", "Summerland", "Hope Ranch", "Santa Ynez", "Solvang", "Buellton", "Los Olivos", "Ballard", "Lompoc", "Santa Maria", "Ojai", "Ventura", "Oxnard", "Camarillo", "Moorpark", "Thousand Oaks"],
  "San Luis Obispo": ["San Luis Obispo", "Paso Robles", "Pismo Beach", "Arroyo Grande", "Grover Beach", "Morro Bay", "Cambria", "Templeton", "Atascadero", "Nipomo"],
  "Los Angeles": ["Los Angeles", "Beverly Hills", "West Hollywood", "Santa Monica", "Malibu", "Culver City", "Brentwood", "Pacific Palisades", "Bel Air", "Hollywood", "Silver Lake", "Echo Park", "Downtown Los Angeles", "Arts District", "Pasadena", "Arcadia", "Monrovia", "Burbank", "Glendale", "Studio City", "Sherman Oaks", "Encino", "Tarzana", "Woodland Hills", "Calabasas", "Agoura Hills", "Long Beach", "San Pedro", "Torrance", "Redondo Beach", "Hermosa Beach", "Manhattan Beach", "El Segundo", "Hawthorne", "Inglewood", "Gardena", "Carson", "Lakewood", "Whittier", "Santa Clarita", "Valencia", "Simi Valley", "Chatsworth", "Northridge", "Granada Hills", "Van Nuys", "Altadena", "La Canada Flintridge"],
  ...
  "San Diego": ["San Diego", "La Jolla", "Del Mar", "Coronado", "Chula Vista", "Escondido", "Carlsbad", "Encinitas", "Solana Beach", "Oceanside", "Temecula", "Fallbrook", "Rancho Santa Fe", "El Cajon", "Santee", "La Mesa", "Poway", "San Marcos", "Vista", "Bonsall", "Valley Center", "Ramona", "Alpine", "Lakeside", "National City", "Imperial Beach"],
  ...
  "Sacramento": ["Sacramento", "Folsom", "El Dorado Hills", "Roseville", "Granite Bay", "Davis", "Woodland", "Elk Grove", "Rancho Cordova", "Citrus Heights", "Rocklin", "Lincoln", "Loomis", "Orangevale", "Fair Oaks", "Galt"],
  "Gold Country": ["Auburn", "Grass Valley", "Nevada City", "Placerville", "El Dorado Hills", "Cameron Park", "Shingle Springs", "Georgetown", "Coloma", "Lotus", "Garden Valley", "Sonora", "Jamestown", "Angels Camp", "Jackson", "Sutter Creek", "Amador City", "Ione"],
  ...
  "Central Valley": ["Fresno", "Bakersfield", "Stockton", "Modesto", "Visalia", "Madera", "Porterville", "Tulare", "Hanford", "Lodi", "Turlock", "Merced", "Tracy", "Manteca"],
  "Shasta & Northern CA": ["Redding", "Chico", "Red Bluff", "Oroville", "Yuba City", "Marysville", "Anderson", "Corning", "Colusa", "Willows", "Orland"],
  ...
  "Lake County & North Bay": ["Lakeport", "Clearlake", "Kelseyville", "Middletown", "Cobb", "Upper Lake", "Nice", "Lucerne", "Eureka", "Arcata", "Fortuna"],
};
